...
<div id="hoyo_wrapper">
    ...
    <div class="fm_title_wrapper">
        <div class="fm_thetitle">
            <h2 class="PH2"><span id="GObackendTour">行程管理</span> > 官方修改行程 > 修改完成</h2>
        </div>
    </div>
   ...
   <!--  <div class="fm_wrapper">
    ...
    <div class="fm_wrapper fm_center">
        ...
        <div class="fm1_cont">
        	<div class="fm1_cont_box_complete">
                ...
                <p>已修改成功！</p>
                <br>
                <p>您可以 <a href="backendTour.php">繼續修改</a> 官方行程</p>
        	</div>
        </div>
    </div>
    ...
    <script>
        ...
        //產生自由行的資訊給使用者看
        var backend_freeMobile_Modify_tr_name = storage['backend_freeMobile_Modify_tr_name'] || '我的官方行程';
        var backend_freeMobile_Modify_tr_no = storage['backend_freeMobile_Modify_tr_no'] || 0;

        $('#tr_info').append("<p>官方行程 <span>#"+backend_freeMobile_Modify_tr_no+" "+backend_freeMobile_Modify_tr_name+"</span></p>");

        storage.removeItem("backend_freeMobile_Modify_tr_name");
        storage.removeItem("backend_freeMobile_Modify_tr_no");       
    </script>
        <script>
            var storage = sessionStorage;
