...
<head>
	...
	*** 學生作品,無任何商業用途 ***
	...
	<link rel="stylesheet" type="text/css" href="css/member/memberpack.css">
	<link rel="stylesheet" type="text/css" href="css/hoyo_nav.css">
	<link rel="stylesheet" type="text/css" href="css/fontello.css">
	<script src="js/jquery.min.js"></script>
	<script src="js/member/memberpack.js"></script>
</head>
<body>
	...
	<div id="memdata" class="ch">
		...
		<section class="breadcrumb">
		    <div class="container">
		        ...
		        <a  class="bread_active" href="#">行程收藏</a>
		    </div>
		</section>
		<!-- 麵包屑end -->
		<div class="headerTitle">
	    	<h2 class="pH2">行程收藏</h2>
	    </div>
		<div class="m_leftBox"><!-- 左邊	menu -->
			...
			<div class="m_nav">	
				<ul>
					...
					<li>
						<a href="memberpack.php"  class="m_nav_active">行程收藏</a>
					</li>
					<li>
...
$sql = 'SELECT * FROM tc JOIN tr WHERE tc.MEM_no=:MEM_no AND tr.TR_close=0 AND tc.TR_no=tr.TR_no ORDER BY TC_time DESC';
$tcData = $pdo->prepare($sql);
$tcData->bindValue(":MEM_no",$memNo);
$tcData->execute();

while($tcRow = $tcData->fetch(PDO::FETCH_ASSOC)){
	$trNo = $tcRow['TR_no'];  // 此行程編號
	$tr_sql = "SELECT * from tr where TR_no=$trNo";
...
echo		'<div class="mW_bigBox">
				...
				<div class="mW_box">
					<input type="hidden" value="'.$tcRow['TR_no'].'">
					...
					<div class="mW_txtBox">
						...
						<p class="mW_title">'.$trRow['TR_name'].'</p>
...
/////////////// 按下刪除 ////////////////////
	$('.mW_delete').click(function(){
		...
		var cancelTC = {'TR_no':trNo};
		$.post('MEM_deleteTC.php',cancelTC);
...
$('.mW_edit').click(function(){
	...
	storage.setItem('transfer_to_free_by_TRno',trNo);
