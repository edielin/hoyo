...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/backend/backendLM/backend_createLM.css">
	...
	<script>
		...
		$(document).ready(function(){
			$('.input_all').focus(function(){
				...
				.animate({'background-position-x':'6px'},1000,'easeOutBounce')
			});
...
<div id="hoyo_wrapper">
	...
	<div class="ML_container LM_ch">
		...
		<section>
			<div class="container">
				<div class="headerTitle">
					<h2 class="pH2"><span id="GObackendTour">地標管理</span> > 新增地標</h2>
				</div>
		...
		<section class="ml_w">
			...
			<form id="myForm" action="backend_createLM_php.php" method="post" enctype="multipart/form-data">
	
				<div class="pextension filterFirst">
	 				<select name="pexDro" id="L_branch" class="pexDro drowStyle ch" style="background-image: url(icon/back_select_branch.png)">
				...
				<div class="pdays filterNth ch">
	         		<select name="pdaysDro" id="pdaysDro" class="pdaysDro drowStyle ch" style="background-image: url(icon/back_select_station.png)">
	...
	<!-- 				<div class="ml_eat">
				...
				<div class="LM_form">
					<input type="submit" value="送出" class="LM_btn" id="createLM">
					<input type="button" value="取消" class="LM_btn cancel_btn">
				</div>
			</form>
		</section>
		...
		<?php include 'php/backend/import_LMcard_All.php';?>
		<script src="js/backend/backendLM/backend_createLM.js"></script>
